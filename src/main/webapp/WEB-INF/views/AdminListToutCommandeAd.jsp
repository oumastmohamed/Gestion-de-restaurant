...
<div id="page-wrapper">
	...
	<!--Search Section Start-->
        ...
        <div class="form-group input-group col-md-6 col-md-offset-3">
        	<form action="CommandeRechercherAd">
                                    ...
                                    <tbody>
                                        <c:forEach items="${toutCommandes}" var="c">
											<tr>
												...
												<td><a href="detailComAd?idComm=${c.idCommande}">Détails</a></td>
												<td><a href="javascript:confirmer('suppCommAd?idComm=${c.idCommande}')">Supprimer</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
