                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach items="${commandesC}" var="c">
											<tr>
												<td>${c.idCommande}</td>
												<td>${c.dateCommande}</td>
												<td><a href="DisponibiliteCom?idComm=${c.idCommande}">${c.etatCommande}</a></td>
												<td><a href="detailCom?idComm=${c.idCommande}">Détails</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
