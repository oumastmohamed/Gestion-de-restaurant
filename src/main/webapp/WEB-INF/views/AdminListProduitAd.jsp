...
<div id="page-wrapper">
	...
	<!--Search Section Start--> 
        ...
        <div class="form-group input-group col-md-6 col-md-offset-3">
        	<form action="ProduitRechercherAd">
                ...
                <div class="col-md-3">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                            <a href="editProdAd?idProd=${p.idProduit}" class="btn btn-success btn-lg btn-block">Modifier</a>
                             <a href="javascript:confirmer('suppProdAd?idProd=${p.idProduit}')" class="btn btn-success btn-lg btn-block">Supprimer</a>
                             </div>
                        </div>
                    </div>
               </div>
