...
<div id="page-wrapper">
	...
	<div class="row">
            <div class="col-md-12">
				...
				<div align="right">
            	<a href="consulterPanierSer" class="btn btn-primary" >Consulter votre panier</a>
            	</div>
	...
	<!--Search Section Start--> 
        ...
        <div class="form-group input-group col-md-6 col-md-offset-3"> 
        	<form action="ProduitCommandRechercherSer">
                ...
                <div class="col-md-3">
                    <div class="panel normal-table panel-primary adjust-border-radius">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="">
                            <a href="ajouterPanierSer?idProd=${p.idProduit}" class="btn btn-primary btn-block btn-lg adjust-border-radius">AJOUTER AU PANIER</a>
                             </div>
                        </div>
                    </div>
               </div>
